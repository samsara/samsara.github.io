...
about the general [Design principles](/docs/design/design-principles)
and start developing your own stream processing pipeline as described
in [Getting started with development](/docs/development/get-started-core)
and [Samsara Stream processing](/docs/development/stream-processing).
